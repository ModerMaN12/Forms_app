...
class _CreateLocalSurveyScreenState extends ConsumerState<CreateLocalSurveyScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Create Local Survey')),
      body: Form(
        key: _formKey,
        child: Column(
          children: [
                  ...
                  if (_questions.isEmpty)
                    Center(
                      child: Padding(
                        ...
                        child: Text('Tap + to add questions', style: TextStyle(color: Colors.grey[500])),
                      ),
                    ),
                ],
              ),
            ...
            Container(
              ...
              child: SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  child: const Text('Create Survey (Offline)'),
                ),
              ),
            ),
          ],
